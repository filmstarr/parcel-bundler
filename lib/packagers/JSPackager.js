  ...
  start() {
    ...
    return (0, _asyncToGenerator2.default)(function* () {
      ...
      if (_this.options.target === 'electron') {
        preludeCode = `process.env.HMR_PORT=${_this.options.hmrPort};process.env.HMR_HOSTNAME=${JSON.stringify(_this.options.hmrHostname)};process.env.HMR_PROTOCOL=${JSON.stringify(_this.options.hmrProtocol)};` + preludeCode;
      }
